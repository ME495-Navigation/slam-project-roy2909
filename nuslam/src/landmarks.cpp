...
public:
  ...
  : Node("landmarks")
  {
    ...
    estimated_landmark_positions_pub_ = create_publisher<visualization_msgs::msg::MarkerArray>(
      "estimated_landmark_positions", 10);
    // Create a subscriber for the laser scan data.
    scan_sub_ =
      create_subscription<sensor_msgs::msg::LaserScan>(
      "/scan", 10,
      std::bind(&Landmarks::scan_callback, this, _1));
  }
...
private:
  void scan_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
  {
    ...
    turtlelib::Landmark landmark =
      turtlelib::Landmark(ranges, msg->angle_increment, msg->angle_min);
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
    estimated_landmark_positions_pub_;
